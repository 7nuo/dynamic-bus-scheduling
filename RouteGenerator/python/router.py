...
if __name__ == '__main__':
    ...
    myMap = Map('uppsala.osm')
    # myMap = Map('testmap.xml')
    ...
    for bus_stop in myMap.busStopList:
        print 'Name: ', bus_stop.name, ' - Longitude: ', bus_stop.longitude, ' - Latitude: ', bus_stop.latitude
    ...
    nTo = (17.6454066, 59.8582443)
    nFrom = (17.643448, 59.8606256)
